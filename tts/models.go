...
type TranscriptWord struct {
	...
	StartTime     float64   // Start time of the word in seconds
	EndTime       float64   // End time of the word in seconds
	...
	RealStartTime time.Time // The actual start time of the word
}
